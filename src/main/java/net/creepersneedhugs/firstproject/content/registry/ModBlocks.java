...
public class ModBlocks {
    ...
    public static final Block DEEPSLATE_TIN_ORE = register(
            new Block(AbstractBlock.Settings.create().sounds(BlockSoundGroup.DEEPSLATE).strength(4.5f)),
            "deepslate_tin_ore",
            true
    );
    ...
    public static final Block TIN_ORE = register(
            new Block(AbstractBlock.Settings.create().sounds(BlockSoundGroup.STONE).strength(3.0f)),
            "tin_ore",
            true
    );
